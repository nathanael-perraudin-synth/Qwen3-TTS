...
@dataclass
class VoiceClonePromptItemStandalone:
    """
...
class Qwen3TTSModelStandalone:
    ...
    def create_voice_clone_prompt(
    ...
    ) -> List[VoiceClonePromptItemStandalone]:
        """
        ...
        items: List[VoiceClonePromptItemStandalone] = []
    ...
    def _prompt_items_to_voice_clone_prompt(self, items: List[VoiceClonePromptItemStandalone]) -> Dict[str, Any]:
        return dict(
    ...
    def generate_voice_clone(
        ...
        ref_text: Optional[Union[str, List[Optional[str]]]] = None,
        x_vector_only_mode: Union[bool, List[bool]] = False,
        voice_clone_prompt: Optional[Union[Dict[str, Any], List[VoiceClonePromptItemStandalone]]] = None,
        ...
        **kwargs,
        ...
        You can provide either:
          ...
          - `VoiceClonePromptItemStandalone` returned by `create_voice_clone_prompt`, OR
          - a list of `VoiceClonePromptItemStandalone` returned by `create_voice_clone_prompt`.
        ...
        Args:
            ...
            voice_clone_prompt:
                list[VoiceClonePromptItemStandalone] from `create_voice_clone_prompt`.
            non_streaming_mode:
