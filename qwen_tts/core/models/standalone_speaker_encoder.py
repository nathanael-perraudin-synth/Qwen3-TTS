"""Standalone speaker encoder without transformers dependency."""
import torch
...
class StandaloneSpeakerEncoder(torch.nn.Module):
    """Standalone speaker encoder without transformers dependency.
    
    An implementation of the speaker embedding model based on:
    ...
    def forward(self, hidden_states):
        """
        Args:
            hidden_states: Tensor of shape (batch, seq_len, mel_dim)
        
        Returns:
            Tensor of shape (batch, enc_dim)
        """
